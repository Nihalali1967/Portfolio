            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2">
                    ...
                    <div className="flex ">
                        ...
                        <a className="ml-4" href="www.linkedin.com/in/nihal-ali-v-a72784235" target="_blank" rel="noreferrer">
                            <img src={dribbble} alt="" />
                        </a>
                        <a className="ml-4" href="nihalali1967@gmail.com" target="_blank" rel="noreferrer">
                            <img src={email} alt="" />
                        </a>
                    </div>
                </div>
